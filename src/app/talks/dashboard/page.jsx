...
function UserDashboard() {
  ...
  const fetchUser = async () => {
    const response = await fetch(`https://axios-week.onrender.com/api/v1/users/getUserEmailById/${id}`);
  ...
  const getUserReputation = async () => {
    try {
      const response = await axios.post("https://axios-week.onrender.com/api/v1/votes/getNetVotes", {
        authorEmail: mail
      }, {
        headers: {
  ...
  const questionsAsked = async () => {
    try {
      const response = await axios.post("https://axios-week.onrender.com/api/v1/votes/getQuestionsAskedByUser", {
        authorEmail: mail
      }, {
        headers: {
          'Content-Type': 'application/json'
  ...
  const answersGiven = async () => {
    try {
      const response = await axios.post("https://axios-week.onrender.com/api/v1/votes/getAnswersByUser", {
        authorEmail: mail
      }, {
        headers: {
          'Content-Type': 'application/json'
  ...
  const blogsWritten = async () => {
    try {
      const response = await axios.post("https://axios-week.onrender.com/api/v1/blogs/getBlogsByAuthor", {
        authorId: id
      }, {
        headers: {
          'Content-Type': 'application/json'
