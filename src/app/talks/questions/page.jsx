...
function QuestionsList() {
    ...
    //write a function to fetch questions from the backend using this api "https://axios-week.onrender.com/api/v1/questions/allQuestions" --> use useEffect to call the function
